...
public class BTConnectionHandler {
    ...
    private static final String TAG = "BTConnectionHandler";
    ...
    public BTConnectionHandler(Handler handler){
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(BTUtility.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device, final String socketType) {
        ...
        Message msg = mHandler.obtainMessage(BTUtility.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(BTUtility.DEVICE_NAME, device.getName());
        msg.setData(bundle);
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(BTUtility.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(BTUtility.TOAST, "Unable to connect to device");
        msg.setData(bundle);
        mHandler.sendMessage(msg);

        // Start the service over to restart listening mode
        BTConnectionHandler.this.start();
    }
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(BTUtility.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(BTUtility.TOAST, "Device connection was lost");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    ...
    private class ConnectedThread extends Thread {
		...
		public void run() {
            ...
            while (true) {
                try {
                    ...
                    mHandler.obtainMessage(BTUtility.MESSAGE_READ, data).sendToTarget();
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mHandler.obtainMessage(BTUtility.MESSAGE_WRITE, -1, -1, buffer).sendToTarget();
