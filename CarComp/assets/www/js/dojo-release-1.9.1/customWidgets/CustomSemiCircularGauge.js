define("customWidgets/CustomSemiCircularGauge", [
		"dojo/_base/lang",
		"dojo/_base/declare",
		"dojo/_base/Color",
	...
	function(lang, declare, Color, utils, CircularGauge, LinearScaler, CircularScale, CircularValueIndicator, CircularRangeIndicator, DefaultPropertiesMixin, TextIndicator){
		return declare("CustomSemiCircularGauge", [CircularGauge, DefaultPropertiesMixin], {
			// summary:
			...
			//label at the top of this gauge
			indicatorText: null,
			...
			constructor: function(args, node){
				...
				this.indicatorText.set("x", 120);
				this.indicatorText.set("y", 80);
