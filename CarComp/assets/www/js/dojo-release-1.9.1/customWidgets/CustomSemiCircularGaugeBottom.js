define("customWidgets/CustomSemiCircularGaugeBottom", ["dojo/_base/lang", "dojo/_base/declare", "dojo/_base/Color", 
	...
	function(lang, declare, Color, CircularGauge, LinearScaler, CircularScale, CircularValueIndicator, CircularRangeIndicator, DefaultPropertiesMixin, TextIndicator){
	return declare("CustomSemiCircularGaugeBottom", [CircularGauge, DefaultPropertiesMixin], {
		// summary:
		...
		//label at the bottom of this gauge
		indicatorText: null,
		...
		constructor: function(){
			...
			// Indicator Text
			this.indicatorText = new TextIndicator();
			this.indicatorText.set("x", 185);
			this.indicatorText.set("y", 145);
			this.indicatorText.set("font", {
				family: "Helvetica",
				weight: "bold",
				size: "16pt",
				color: "#CECECE"
			});
			this.addElement("indicatorText", this.indicatorText);
		...
		_setLabelAttr: function(label){	
			this.indicatorText.set("value", label);
		}
	});
});
