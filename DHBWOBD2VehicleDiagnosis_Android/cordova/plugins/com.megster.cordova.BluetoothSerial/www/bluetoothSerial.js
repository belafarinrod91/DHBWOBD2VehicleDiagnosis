...
module.exports = {
	...
	activateBluetooth: function(success, failure) {
		cordova.exec(success, failure, "BluetoothSerial", "activateBluetooth",
				[]);
	},

	deactivateBluetooth : function(success, failure) {
		cordova.exec(success, failure, "BluetoothSerial", "deactivateBluetooth",
				[]);
	},
	...
	connect : function(macAddress, success, failure) {
		cordova.exec(success, failure, "BluetoothSerial", "connect",
				[ macAddress ]);
	},

	// Android only - see http://goo.gl/1mFjZY
	connectInsecure : function(macAddress, success, failure) {
		cordova.exec(success, failure, "BluetoothSerial", "connectInsecure",
				[ macAddress ]);
	},
	...
	// the number of bytes of data available to read is passed to the success
	// function
	...
	readUntil : function(delimiter, success, failure) {
		cordova.exec(success, failure, "BluetoothSerial", "readUntil",
				[ delimiter ]);
	},
