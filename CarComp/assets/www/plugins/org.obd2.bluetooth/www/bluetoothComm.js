cordova.define("org.obd2.bluetooth.BluetoothConnection", function(require,
		exports, module) {
	var bConnection = {

		enableBT : function(success, failure) {
			cordova.exec(success, failure, "BluetoothConnection", "enableBT",
					[]);
		},

		disableBT : function(success, failure) {
			cordova.exec(success, failure, "BluetoothConnection", "disableBT",
					[]);
		},

		isBTEnabled : function(success, failure) {
			return cordova.exec(success, failure, "BluetoothConnection",
					"isBTEnabled", []);
		},
		...
		pair : function(macAddress, success, failure) {
			cordova.exec(success, failure, "BluetoothConnection", "pair",
					[ macAddress ]);
		},
		...
		connect : function(address, success, failure) {
			cordova.exec(success, failure, "BluetoothConnection", "connect",
					[ address ]);
		},
