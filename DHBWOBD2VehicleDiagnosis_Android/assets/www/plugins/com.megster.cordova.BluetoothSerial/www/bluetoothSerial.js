cordova.define("com.megster.cordova.BluetoothSerial.bluetoothSerial",
		function(require, exports, module) {/* global cordova */
			module.exports = {

				discoverDevices : function(success, failure) {
					cordova.exec(success, failure, "BluetoothSerial",
							"discoverDevices", []);
				},

				activateBluetooth : function(success, failure) {
					cordova.exec(success, failure, "BluetoothSerial",
							"activateBluetooth", []);
				},

				deactivateBluetooth : function(success, failure) {
					cordova.exec(success, failure, "BluetoothSerial",
							"deactivateBluetooth", []);
				},

				stopDiscovering : function(success, failure) {
					return cordova.exec(success, failure, "BluetoothSerial",
							"stopDiscoverDevices", []);
				},
				...
				// the number of bytes of data available to read is passed to
				...
				// reads the data in the buffer up to and including the
				// delimiter
				...
				// writes data to the bluetooth serial port - data must be a
				// string
				write : function(data, success, failure) {
					cordova.exec(success, failure, "BluetoothSerial", "write",
							[ data ]);
				},
